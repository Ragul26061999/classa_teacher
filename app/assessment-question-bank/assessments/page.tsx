          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-sm w-full relative flex flex-col items-center border border-gray-200">
              ...
              <div className="flex flex-col gap-3 w-full">
                ...
                <button className="bg-purple-100 text-purple-900 px-5 py-3 rounded-lg font-medium border border-purple-100 hover:bg-purple-200 hover:text-purple-900 transition" onClick={() => { setShowDialog(false); router.push('/assessment-question-bank/assessments/neet-mock-creation'); }}>Create NEET MOCK</button>
                <button className="bg-green-100 text-green-900 px-5 py-3 rounded-lg font-medium border border-green-100 hover:bg-green-200 hover:text-green-900 transition" onClick={() => { setShowDialog(false); router.push('/assessment-question-bank/assessments/jee-mock-creation'); }}>Create JEE Mock</button>
                <button className="bg-pink-100 text-pink-900 px-5 py-3 rounded-lg font-medium border border-pink-100 hover:bg-pink-200 hover:text-pink-900 transition" onClick={() => { setShowDialog(false); router.push('/assessment-question-bank/assessments/pyq-test-creation'); }}>Create PYQ test</button>
              </div>
            </div>
          </div>
        )}
